use mivon_compiler::hir::{HirSignal, LazyElaborator};
...
impl HirHandle {
    ...
    pub fn register_module(&mut self, name: mivon_core::intern::Symbol, signals: Vec<HirSignal>) {
        self.inner
...
mod tests {
    use super::*;
    use mivon_compiler::hir::HirType;
