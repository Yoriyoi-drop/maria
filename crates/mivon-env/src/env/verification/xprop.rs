use mivon_simulator::simulator::types::XPropagationMode;
use mivon_simulator::simulator::value::set_xprop_mode;
...
pub fn current_xprop() -> XPropMode {
    let current = mivon_simulator::simulator::value::get_xprop_mode();
    match current {
