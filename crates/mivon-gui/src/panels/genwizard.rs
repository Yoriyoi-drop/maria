...
//! dalam beberapa klik (sesuai desain Command Palette Mivon). Pengguna mengisi
...
pub fn gen_module_source(
    ...
    s.push_str("// Generated by Mivon — RTL Engineering Control Center\n\n");
...
mod tests {
    use super::*;
    use crate::state::{GenKind, GenParam, GenPort, GuiState};
