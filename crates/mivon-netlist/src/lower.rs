...
use mivon_sir::{SirModule, SirNodeKind, SirValue};
...
fn ff_kind(r: &mivon_sir::SirRegister) -> CellKind {
...
fn clamp_u64(lv: &mivon_core::LogicVec) -> u64 {
    lv.to_u64()
}
...
mod tests {
    ...
    fn comb_port_input_gets_net_with_name() {
        ...
        m.inputs.push(mk("a", mivon_sir::PortDir::Input, 0, 8));
        m.inputs.push(mk("b", mivon_sir::PortDir::Input, 1, 8));
        m.outputs.push(mk("y", mivon_sir::PortDir::Output, 3, 8));
