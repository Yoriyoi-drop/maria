...
/// Magic bytes untuk file terenkripsi Mivon.
const MAGIC: &[u8; 8] = b"MIVONENC";
/// Version format enkripsi.
const FORMAT_VERSION: u8 = 1;

/// File terenkripsi Mivon.
#[derive(Debug, Clone)]
...
impl EncryptedIp {
    ...
    /// Check apakah file adalah Mivon encrypted IP.
