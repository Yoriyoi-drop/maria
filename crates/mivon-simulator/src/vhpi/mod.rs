...
//!
//! Adapter ABI-compatible di atas simulation kernel Mivon (arsitektur
//! masukan user poin 1 & 4). Library VHDL eksternal memanggil fungsi
//! `vhpi_*` standar dan menganggap Mivon simulator VHDL-kompatibel.
//!
...
//! VHDL *language parsing* di luar scope — Mivon adalah simulator
