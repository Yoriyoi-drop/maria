...
impl SignalStats {
    ...
    pub fn record(&mut self, time: u64, signals: &[mivon_ir::LogicVec]) {
...
mod tests {
    use super::*;
    use mivon_ir::{IrDesign, LogicVec, SignalInfo};

    fn make_design() -> IrDesign {
        let mut design = IrDesign::default();
        design.top.signals = vec![
            SignalInfo {
                name: mivon_core::intern::Symbol::intern("clk"),
                width: 1,
                ..Default::default()
            },
            SignalInfo {
                name: mivon_core::intern::Symbol::intern("data"),
                width: 8,
                ..Default::default()
            },
        ];
