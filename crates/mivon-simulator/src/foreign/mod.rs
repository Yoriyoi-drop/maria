//! Mivon FFI — Unified Foreign Interface (arsitektur masukan user).
//!
//! VPI/VHPI/PLI/DPI adalah ADAPTER di atas simulation kernel Mivon, bukan
...
//! library eksternal tidak pernah menyentuh scheduler Mivon secara langsung.
//!
//! ```text
//!              Mivon FFI
//!                 │
...
//! ```
//!
//! Prinsip: Mivon tidak perlu "menjadi" VPI/VHPI/PLI secara internal — Mivon
...
pub enum ForeignEvent {
    ...
    ValueChange {
        /// Object handle (u64 id — tidak pernah pointer internal Mivon).
        object: u64,
    },
