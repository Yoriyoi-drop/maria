...
//!
//! Library eksternal TIDAK pernah menerima pointer internal Mivon. Semua
//! handle adalah `u64` id yang dipetakan ke object Mivon melalui registry —
...
/// Jenis object Mivon yang bisa di-reference foreign library.
