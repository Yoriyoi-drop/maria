...
//! Coverage Database) implementation for Mivon.
//!
//! # Binary Format
//! - Magic: "MCDB" (4 bytes)
//! - Version: u32 (1)
...
mod tests {
    ...
    fn test_empty_db_save_load() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test_{}", std::process::id()));
    ...
    fn test_covergroup_roundtrip() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test2_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_line_roundtrip() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test3_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_toggle_roundtrip() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test4_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_branch_roundtrip() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test5_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_fsm_roundtrip() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test6_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_merge_from_engine_basic() {
        ...
        // Verify: roundtrip
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test7_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_with_path_load_existing() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test8_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_load_from_path_static() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test10_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_load_and_merge() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test11_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    fn test_export_html_creates_file() {
        let dir = std::env::temp_dir().join(format!("mivon_covdb_test12_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
