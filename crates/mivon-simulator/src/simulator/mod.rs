...
impl JITEvaluator {
    ...
    pub fn eval_binary(
        &mut self,
        _op: &mivon_ir::BinaryIrOp,
        _lhs: &mivon_ir::LogicVec,
        _rhs: &mivon_ir::LogicVec,
    ) -> Option<mivon_ir::LogicVec> {
        None
    }
    pub fn eval_unary(
        &mut self,
        _op: &mivon_ir::UnaryIrOp,
        _val: &mivon_ir::LogicVec,
    ) -> Option<mivon_ir::LogicVec> {
        None
    }
    pub fn eval_expression(
        &mut self,
        _expr: &mivon_ir::IrExpr,
        _signal_values: &[u64],
        _result_width: usize,
    ) -> Option<mivon_ir::LogicVec> {
        None
