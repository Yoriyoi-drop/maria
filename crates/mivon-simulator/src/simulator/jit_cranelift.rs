...
impl CraneliftEngine {
    ...
    fn hash_ir_expr(expr: &mivon_ir::IrExpr) -> u64 {
        use std::hash::Hasher;
    ...
    fn build_expr_ir(
        ...
        use mivon_ir::{BinaryIrOp, IrExpr, UnaryIrOp};
