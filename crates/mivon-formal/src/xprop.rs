...
use mivon_ir::{IrDesign, IrExpr, IrStmt, LogicVal, Process, SignalId};
...
impl XPropAnalyzer {
    ...
    fn eval_binop(&self, op: &mivon_ir::BinaryIrOp, l: Ternary, r: Ternary) -> Ternary {
        use mivon_ir::BinaryIrOp;
        match op {
    ...
    fn eval_unop(&self, op: &mivon_ir::UnaryIrOp, v: Ternary) -> Ternary {
        use mivon_ir::UnaryIrOp;
        match op {
...
mod tests {
    ...
    fn test_eval_binop_bitand() {
        ...
        assert_eq!(
            analyzer.eval_binop(&mivon_ir::BinaryIrOp::BitAnd, Ternary::Zero, Ternary::One),
            Ternary::Zero
        );
        assert_eq!(
            analyzer.eval_binop(&mivon_ir::BinaryIrOp::BitAnd, Ternary::One, Ternary::One),
            Ternary::One
        );
        assert_eq!(
            analyzer.eval_binop(
                &mivon_ir::BinaryIrOp::BitAnd,
                Ternary::Unknown,
                Ternary::One
            ),
            Ternary::Unknown
    ...
    fn test_eval_binop_bitor() {
        let analyzer = XPropAnalyzer::new();
        assert_eq!(
            analyzer.eval_binop(&mivon_ir::BinaryIrOp::BitOr, Ternary::Zero, Ternary::One),
            Ternary::One
        );
        assert_eq!(
            analyzer.eval_binop(&mivon_ir::BinaryIrOp::BitOr, Ternary::Zero, Ternary::Zero),
            Ternary::Zero
        );
        assert_eq!(
            analyzer.eval_binop(&mivon_ir::BinaryIrOp::BitOr, Ternary::One, Ternary::Unknown),
            Ternary::One
        );
    }
    ...
    fn test_eval_binop_logical_and() {
        ...
        assert_eq!(
            analyzer.eval_binop(
                &mivon_ir::BinaryIrOp::LogicalAnd,
                Ternary::Zero,
                Ternary::One
            ),
            Ternary::Zero
    ...
    fn test_eval_unop_not() {
        let analyzer = XPropAnalyzer::new();
        assert_eq!(
            analyzer.eval_unop(&mivon_ir::UnaryIrOp::Not, Ternary::Zero),
            Ternary::One
        );
        assert_eq!(
            analyzer.eval_unop(&mivon_ir::UnaryIrOp::Not, Ternary::One),
            Ternary::Zero
        );
        assert_eq!(
            analyzer.eval_unop(&mivon_ir::UnaryIrOp::Not, Ternary::Unknown),
            Ternary::Unknown
        );
    }
}
