...
use mivon_netlist::cell::{CellInstance, CellKind};
use mivon_netlist::net::{Netlist, PortDir};
...
mod tests {
    use super::*;
    use mivon_core::intern::Symbol;
    use mivon_netlist::cell::{CellInstance, PinConn};
    use mivon_netlist::net::Netlist;
