//! Mivon Timing & Area (SYNTHESIS.md §15/§16 — phase 5).
//!
...
//! ```
//!
//! - `constraint` — parser `.mcs` (Mivon Constraint Specification):
...
//!   unit area (bukan gate count ASIC — itu `mivon-tech`/Liberty fase 6-7).
