        ...
        match c {
            ...
            '\'' => {
                ...
                match next {
                    Some('0') => {
                        self.advance();
                        Token::FillLit(maria_core::LogicVal::Zero)
                    }
                    Some('1') => {
                        self.advance();
                        Token::FillLit(maria_core::LogicVal::One)
                    }
                    Some('x') | Some('X') => {
                        self.advance();
                        Token::FillLit(maria_core::LogicVal::X)
                    }
                    Some('z') | Some('Z') => {
                        self.advance();
                        Token::FillLit(maria_core::LogicVal::Z)
                    }
