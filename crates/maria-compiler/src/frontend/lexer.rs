        ...
        match c {
            ...
            b'\'' => {
                ...
                match next {
                    ...
                    b'1' => {
                        self.skip_byte();
                        Token::FillLit(maria_ir::LogicVal::One)
                    }
                    b'x' | b'X' => {
                        self.skip_byte();
                        Token::FillLit(maria_ir::LogicVal::X)
                    }
                    b'z' | b'Z' => {
                        self.skip_byte();
                        Token::FillLit(maria_ir::LogicVal::Z)
                    }
...
mod tests {
    ...
    always @(posedge clk) begin
        ...
        // Use legacy lexer
        let mut legacy = maria_parser::lexer::Lexer::new(input);
