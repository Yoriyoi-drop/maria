...
impl BuildInfo {
    pub fn current() -> Self {
        BuildInfo {
            // Identitas produk tetap "maria" (bukan "maria-env" — crate ini
            // adalah bagian dari monorepo; `maria::env::BuildInfo` dipakai
            // main.rs/GUI untuk menampilkan versi Maria).
            crate_name: "maria",
