//! Mivon Technology Library — abstraksi device untuk synthesis (SYNTHESIS.md §12).
//!
//! Mivon tidak menganggap semua hardware punya gate yang sama. Teknologi hanya
...
//!
//! Pilih arsitektur di CLI: `mivon synth --preset generic|fpga|asic|custom`.
...
/// `mivon-synth`). Preset `asic`/`custom` belum punya back-end → `None`.
