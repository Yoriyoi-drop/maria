...
fn main() {
    ...
    mem.add(
        RamRegion::new(Symbol::intern("ram"), 0, 0x80000000, RegionKind::Ram, true).unwrap(),
    )
    .unwrap();
    ...
    println!();
    println!("[0x9041] = {:#x}, [0x9045] = {:#x}", mem.read(0x9041, 4).unwrap_or(0), mem.read(0x9045, 4).unwrap_or(0));
