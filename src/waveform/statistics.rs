...
impl SignalStats {
    ...
    pub fn record(&mut self, time: u64, signals: &[crate::ir::LogicVec]) {
...
mod tests {
    use super::*;
    use crate::ir::{LogicVec, IrDesign, SignalInfo};

    fn make_design() -> IrDesign {
        let mut design = IrDesign::default();
        design.top.signals = vec![
            SignalInfo {
                name: crate::intern::Symbol::intern("clk"),
                width: 1,
                ..Default::default()
            },
            SignalInfo {
                name: crate::intern::Symbol::intern("data"),
                width: 8,
                ..Default::default()
            },
        ];
